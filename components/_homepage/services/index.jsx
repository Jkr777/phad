  ...
  return (
    <section className={classes.container}>
      ...
      <div className={classes.info}>
        <span className={`${classes.infoItem} ${classes.big4}`}><TbPointFilled style={{marginRight: "5px", minWidth: "20px"}} />{txt.title1}</span>
      ...
      <div className={classes.info2}>
        <span className={`${classes.infoItem} ${classes.big4}`}><TbPointFilled style={{marginRight: "5px", minWidth: "20px"}} />{txt.title2}</span>
