  ...
  return (
    <section>
      ...
      <div className={reClass.sPage}>
        ...
        <span className={classes.item}><MdDone style={{marginRight: "5px", fontSize: "20px", minWidth: "20px"}}  />{txt.projName2}</span>
        <span className={classes.item}><MdDone style={{marginRight: "5px", fontSize: "20px", minWidth: "20px"}}  />{txt.projName3}</span>
        <span className={classes.item}><MdDone style={{marginRight: "5px", fontSize: "20px", minWidth: "20px"}}  />{txt.projName4}</span>
