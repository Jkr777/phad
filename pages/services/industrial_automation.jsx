    ...
    <section>
      ...
      <div className={reClass.sPage}>
        ...
        <div className={servicesClass.infoCart}>
          ...
          <p className={reClass.pStyle}>{txt.s3p1}</p>
        </div>
        
        <h2 className={reClass.subTitle}>{txt.servicesTitle}</h2>

        <p><MdDone style={{ display: "inline-block", position: "relative", top: "-3px", marginRight: "5px", fontSize: "20px", minWidth: "15px"}} />{txt.projectS3p1}</p>
        <p><MdDone style={{ display: "inline-block", position: "relative", top: "-3px", marginRight: "5px", fontSize: "20px", minWidth: "15px"}} />{txt.projectS3p2}</p>
