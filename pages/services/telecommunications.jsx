    ...
    <section>
      ...
      <div className={reClass.sPage}>
        ...
        <div className={servicesClass.infoCart}>
          ...
          <p className={reClass.pStyle}>{txt.s6p1}</p>
          <p className={reClass.pStyle}>{txt.s6p2}</p>
          <p className={reClass.pStyle}>{txt.s6p3}</p>
        </div>

        <h2 className={reClass.subTitle}>{txt.servicesTitle}</h2>

        <p><MdDone style={{ display: "inline-block", position: "relative", top: "-3px", marginRight: "5px", fontSize: "20px", minWidth: "15px"}} />{txt.projectS6p1}</p>
